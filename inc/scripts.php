...
function referrer_analytics_scripts() {
  ...
  if ( 'enabled' === $options['store_cookies'] ) {
    ...
    wp_enqueue_script( 'referrer-analytics', plugin_dir_url( REFERRER_ANALYTICS ) . '/assets/js/referrer-analytics.js', [ 'referrer-analytics-cookie' ], REFERRER_ANALYTICS_VERSION );
  }
}
